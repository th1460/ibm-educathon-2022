...
Thiago Pires | Abr 2022 <br>
[github.com/th1460/ibm-educathon-2022](https://github.com/th1460/ibm-educathon-2022)
...
```{bash eval=FALSE}
git clone git@github.com:th1460/ibm-educathon-2022.git
```
